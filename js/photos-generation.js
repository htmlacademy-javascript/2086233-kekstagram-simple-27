...
for (let i = 0; i < POSTS_COUNT; i++) {
  ...
  photoPost.querySelector('.picture__likes').value = postsContent[i].likes; // Присваиваем число лайков и комментов в <span> внутри <p>
  photoPost.querySelector('.picture__comments').value = postsContent[i].comments;
